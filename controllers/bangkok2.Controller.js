...
const getData = async (AppID) => {
    ...
    try {
        ...
        const sqls = `SELECT a.AppID ,a.PlaceSubjectNo,a.PlaceID,a.PlaceName,a.PlaceBuliding,a.PlaceRoom,a.PlaceRoomNo,a.PlaceFloor,a.PlaceTable,a.PlaceRound,a.PlaceRoundName,a.HdPosition,a.Position, b.* FROM bangkok202402_appid_place2 a INNER JOIN bangkok202402_customer b ON a.RefNo1 = b.RefNo1 WHERE a.AppID = '${AppID}' `
        console.log(sqls)
...
export const Bangkok2 = async (req, res) => {
    // console.log(">><<")
